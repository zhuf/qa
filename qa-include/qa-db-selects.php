...
*/
	...
	function qa_ldap_login($inemailhandle, $inpassword)
	{
		$ds = ldap_connect("ldap://directory.163.org");
		ldap_set_option($ds, LDAP_OPT_PROTOCOL_VERSION,3);
		ldap_set_option($ds, LDAP_OPT_REFERRALS,0);

		$r=ldap_bind($ds, "uid=".$inemailhandle.", ou=people, dc=corp, dc=netease, dc=com", $inpassword);
